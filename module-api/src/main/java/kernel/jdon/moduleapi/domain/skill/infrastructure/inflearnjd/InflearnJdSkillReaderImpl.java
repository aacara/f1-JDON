...
public class InflearnJdSkillReaderImpl implements InflearnJdSkillReader {
    ...
    @Override
    public List<SkillInfo.FindLecture> findInflearnLectureListBySkill(final List<String> keywordList,
        final Long memberId) {
        return skillRepository.findInflearnLectureListBySkill(keywordList, memberId).stream()
